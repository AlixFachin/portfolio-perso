    ...
    <div className="self-introduction">
      ...
      <div className="bio-container">
        ...
        <div className="bio-text">
          ...
          <p> After leaving finance and coming back to Japan in 2012, I worked as a manager in a property management company in Niseko. During this time, I coded on the side, learning Swift or Ruby. 
