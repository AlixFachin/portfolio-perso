    ...
    <div className="self-introduction">
      ...
      <div className="bio-container">
        ...
        <div className="bio-text">
          ...
          <p> After this, we settled in Hokkaido where I worked as a manager in a property management company in Niseko. During this time, I always coded on the side, trying new languages like Swift or Ruby. When the COVID crisis hit, I decided to use this opportunity to refresh my IT skills, so I subscribed to an intensive coding bootcamp in Tokyo. I am ready now to do what I excel and work as a software engineer again. </p>
